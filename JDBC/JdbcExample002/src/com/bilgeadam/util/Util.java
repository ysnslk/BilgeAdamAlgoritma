...
public class Util {
	...
	public static int intValue(String sorgu) {
	...
	public static double doubleValue(String sorgu) {
		System.out.println(sorgu);
		boolean kontrol = false;
		double deger = 0;
		do {
	...
	public static String stringValue(String sorgu) {
		System.out.println(sorgu);
	...
	public static LocalDate stringTarih() {
		...
		do {
			try {
				date = LocalDate.parse(stringValue("Lütfen bir tarih degeri giriniz(yıl-ay-gün)"));
				kontrol = false;
	...
	// kullanıcıdan string olarak tarih alcaz (yıl-ay-gün) aldıgımız değeri
	// localDate e çevircez
